...
class _requete {
     ...
     * @return void
     */
    public function __construct($fields = [], $mainTable = "", $tables= [], $partionnement = true, $filtres = [], $order = [], $limit = []) {
        $this->fields = $fields;
     ...
     */
    public function makeFiltres($filtres = [], $liaisonContraintes = " AND ") {
     ...
     */
    public function makeUnFiltre($unFiltre,$index) {
        ...
        elseif($fields[$unFiltre["champ"]]->get("type") === "text") {
     ...
     * @return boolean - True si tout s'est bien passé sinon False
     */
    public function makeUnFiltreValeur($unFiltre,$index,$type) {
     ...
     */
    public function makeParamForSet($field) {
        // On construit la clé du paramètre
     ...
     */
    public function makeFiltrePartitionnement() {
