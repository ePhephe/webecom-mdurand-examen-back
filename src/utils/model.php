...
class _model {
     ...
     * @return void
     */
    public function __construct($id = null, $partitionement = false) {
     ...
     */
    public function champ_id() {
        return $this->champ_id;
    }

    /**
     * Retourne l'abbrev de la table de l'objet
     *
     * @return string - Abréviation de la table
     */
    public function abrev_table() {
        return $this->abrev_table;
    }
     ...
     */
    public function loadFromTab($data) {
        //On parcourt tous les champs
     ...
     */
    public function list($arrayTables = [], $arrayFiltres = [],$arrayCriteresTri = [], $arrayLimit = []) {
        // On instancie un objet de la classe _requete avec les informations nécessaires
        $objRequete = new _requete(
            $this->fields,
            $this->table,
     ...
     */
    public function getFormulaire($action, $json=false, $withButton=true, $paramAction =[], $listInput=[], $others = []){
        ...
        switch ($action) {
            ...
            case 'create':
                ...
                $buttonSubmit = '<input type="submit" value="Ajouter">';
                // Bouton secondaire, pas d'action déclencher de base
                $buttonAnnuler = '<input type="button" value="Annuler" id="btn-cancel">';
            ...
            case 'read':
                ...
                $buttonSubmit = '';
                // Bouton secondaire, pas d'action déclencher de base
                $buttonAnnuler = '<input type="button" value="Retour à la liste" id="btn-cancel">';
                // Paramètre de vision des champs dans le formulaire
                $acces = 'readonly';
                break;
     ...
     * @return boolean True si tout est OK sinon False
     */
    public function verifParamsFormulaire($arrayPost){
