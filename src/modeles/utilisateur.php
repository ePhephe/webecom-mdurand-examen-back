...
class utilisateur extends _model {
    ...
    protected $fieldToken = "u_token_reini_password";
    ...
    function demandeReiniPassword($strLogin){
        ...
        $urlToEmail = 'http://exam-back.mdurand.mywebecom.ovh/'.$this->arrayURL["formNewPassword"].'?'.http_build_query([
